...
// PostalCodeProvider provides access to Italian postal code data.
...
//
// Parameters:
//   - postalCode: Italian postal code (5 digits, e.g., "00118")
//
// Returns:
...
//
// Parameters:
//   - postalCode: Italian postal code to validate (5 digits)
//
// Returns:
